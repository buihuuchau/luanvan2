            ...
            <div class="content">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            <form action="{{ route('doikhuvuchoadonphone') }}" method="get">
                                {{ csrf_field() }}
                        ...
                        <div class="card mr-auto" style="width: 114px; height: 162px;">
                            <form action="{{ route('dodoibanhoadonphone') }}" method="get">
                                {{ csrf_field() }}
                                <input type="hidden" name="id" value="{{ $id }}">
