                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button type="button" class="btn btn-danger">
                                        <a style="color:black" href="{{route('diemdanhcomatlichlamviec',['id'=>$row3->id])}}">{{$row3->hoten}}--->Chưa điểm danh</a>
                                    </button><br>
                                    @else
                                    <button type="button" class="btn btn-success">
                                        <a style="color:black" href="{{route('diemdanhvangmatlichlamviec',['id'=>$row3->id])}}">{{$row3->hoten}}--->Đã điểm danh</a>
                                    </button><br>
                                    @endif
                                    @endif
                                    @endforeach
