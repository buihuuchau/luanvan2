    ...
    <div class="content-header">
        <div class="container-fluid">
            ...
            <div class="col-sm-6">
                ...
                <li class="breadcrumb-item"><a href="">Sửa khu vực</a></li>
                </ol>
            </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        <div class="row">
            <form action="{{route('doeditkhuvuc')}}" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" name="id" value="{{$khuvuc->id}}">
                    <input type="text" class="form-control" name="tenkhuvuc" value="{{$khuvuc->tenkhuvuc}}" required><br>
