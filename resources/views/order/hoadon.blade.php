        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="card" style="width: 114px; height: 285px;">
                    ...
                    <button class="btn btn-primary btn-sm"><a href="{{ route('doimonhoadon', ['id' => $row->id]) }}" style="font-weight:bold; color:black; font-size:22px; text-align:center;">Đổi
                            món</a></button>
                    <button class="btn btn-warning btn-sm"><a href="{{ route('doibanhoadon', ['id' => $row->id]) }}" style="font-weight:bold; color:black; font-size:22px; text-align:center;">Đổi
                            bàn</a></button>
                    <!--idban-->
