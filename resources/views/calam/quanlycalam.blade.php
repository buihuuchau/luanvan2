                                    ...
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1"
                                                colspan="1">TỪ GIỜ</th>
                                            <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1"
                                                colspan="1">ĐẾN GIỜ</th>
                                            <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1"
                                                colspan="1">TÊN CA LÀM</th>
                                            <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1"
                                                ...
                                                <td class="row">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control"
                                                                                name="tencalam" value="{{ $row->tencalam }}"
                                                                                required>
                                                                        </div>
																		<div class="form-group">
                                                                            <label>Từ giờ</label>
                                                                            <input type="time" class="form-control"
                                                                                name="tu" value="{{ $row->tu }}"
                                                                                required>
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label>Đến giờ</label>
                                                                            <input type="time" class="form-control"
                                                                                name="den" value="{{ $row->den }}"
                                                                                required>
                                                                        </div>
                                                                    </div>
                                                                    <div class="modal-footer">
													...
													@if ($row->hidden == 0)
                                                        <button class="btn btn-secondary">
                                                            <a href="{{ route('hiddencalam', ['id' => $row->id]) }}"
                                                                style="color: white"><i class="fa fa-times"></i></a>
                                                        </button>
                                                    @else
                                                        <button class="btn btn-success">
                                                            <a href="{{ route('showcalam', ['id' => $row->id]) }}"
