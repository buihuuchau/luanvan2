                        ...
                        <div class="col-md-12 mb-4 text-right">
                            ...
                            <div class="modal fade" id="exampleModalCenter0" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLongTitle">Đổi điểm</h5>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                        </div>
                                        <form action="{{ route('tilegiamgia') }}" method="post">
                                            <div class="modal-body">
                                                {{ csrf_field() }}
                                                <div class="form-group">
                                                    <label class="col-form-label">Hóa đơn bao nhiêu tiền thì đổi được 1 điểm ?</label>
                                                    <input type="number" class="form-control" min="0" name="hoadontodiem" value={{$hoadontodiem}} required>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-form-label">1 điểm đổi được bao nhiêu tiền cho hóa đơn lần sau ?</label>
                                                    <input type="number" class="form-control" min="0" name="diemtohoadon" value={{$diemtohoadon}} required>
                                                </div>
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary"
