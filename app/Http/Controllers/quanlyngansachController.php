...
class quanlyngansachController extends Controller
{
    ...
    public function quanlynhaphang(Request $request)
    {
        ...
        return view('ngansach.quanlyngansach', compact(
            'thanhvien',
            'kho',
            'tong',
            'tungay',
